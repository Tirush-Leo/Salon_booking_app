      ...
      body: Container(child: Column(children: [
        ...
        Form(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              border: Border.all(color: Colors.white70,width: 2.0), borderRadius: BorderRadius.circular(30.0),
            ),
            child: TextFormField(
              validator: (value){
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            child: Text("Send Email", style: TextStyle(color: Colors.white, fontSize: 22.0, fontWeight: FontWeight.bold),),
          ),
        ),
      ],),),
    );
