...
import 'package:salonapp01/pages/signup.dart';
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    Text("Forgot Password?", style: TextStyle(color: Color(0xFF311937), fontSize: 20.0, fontWeight: FontWeight.w500),),
                  ],
                ),
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Center(child: Text("SIGN IN", style: TextStyle(color: Colors.white, fontSize: 26.0, fontWeight: FontWeight.bold),)),
                  ),
                ),
                Spacer(),
                Row(
                  mainAxisAlignment: MainAxisAlignment.end,
                  children: [
                    Text("Don't have Account", style: TextStyle(color: Color(0xFF311937), fontSize: 18.0, fontWeight: FontWeight.w500),),
                  ],
                ),
                GestureDetector(
                  onTap: (){
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.end,
                    children: [
                      Text("Sign up", style: TextStyle(color: Color(0xFF621d3c), fontSize: 25.0, fontWeight: FontWeight.bold),),
                    ],
                  ),
                ),
              ],),
