...
import 'package:salonapp01/Admin/booking_admin.dart';
    ...
    return Scaffold(
      body: Container(child: Stack(children: [
        Container(
          ...
          child: Text("Admin\nPanel", style: TextStyle(color: Colors.white, fontSize: 30.0, fontWeight: FontWeight.bold),),
        ),
        Container(
          ...
          child: Form(
            child: Column(
              ...
              children: [
                Text("Username", style: TextStyle(color: Color(0xFFB91635), fontSize: 25.0, fontWeight: FontWeight.w500),),
                TextFormField(
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Center(child: Text("LOG IN", style: TextStyle(color: Colors.white, fontSize: 26.0, fontWeight: FontWeight.bold),)),
                  ),
                ),
    ...
    FirebaseFirestore.instance.collection("Admin").get().then((snapshot){
      snapshot.docs.forEach((result){
        if(result.data()['id']!= usernamecontroller.text.trim()){
          ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Your Id is not correct", style: TextStyle(fontSize: 20.0),)));
        }
        else if(result.data()['password']!= userpasswordcontroller.text.trim()){
          ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Your Password is not correct", style: TextStyle(fontSize: 20.0),)));
        }
        else{
